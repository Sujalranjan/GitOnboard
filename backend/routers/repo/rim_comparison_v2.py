...
async def compare_rim_stream(
    ...
    async def stream_generator():
        try:
            ...
            # Send WITH RIM result with metrics comparison
            ...
            metrics_diff = {
                "tool_calls_diff": result.with_rim.retrieval_metrics.tool_call_count - result.without_rim.retrieval_metrics.tool_call_count,
                "files_diff": result.with_rim.retrieval_metrics.files_retrieved - result.without_rim.retrieval_metrics.files_retrieved,
                "tokens_diff": result.with_rim.llm_efficiency_metrics.actual_total_tokens - result.without_rim.llm_efficiency_metrics.actual_total_tokens,
                "latency_diff_ms": result.with_rim.llm_efficiency_metrics.total_latency_ms - result.without_rim.llm_efficiency_metrics.total_latency_ms,
                "tool_calls_pct": round(((result.with_rim.retrieval_metrics.tool_call_count - result.without_rim.retrieval_metrics.tool_call_count) / max(1, result.without_rim.retrieval_metrics.tool_call_count)) * 100, 1) if result.without_rim.retrieval_metrics.tool_call_count > 0 else 0,
                "tokens_pct": round(((result.with_rim.llm_efficiency_metrics.actual_total_tokens - result.without_rim.llm_efficiency_metrics.actual_total_tokens) / max(1, result.without_rim.llm_efficiency_metrics.actual_total_tokens)) * 100, 1) if result.without_rim.llm_efficiency_metrics.actual_total_tokens > 0 else 0,
            }
